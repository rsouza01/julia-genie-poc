...
# !!! Main.UserApp is configured as an alias for Main.JuliaGeniePoc and you might encounter it in some tests
using Main.JuliaGeniePoc, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "JuliaGeniePoc tests" begin
  @includetests ARGS
end
