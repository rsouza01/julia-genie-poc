...
# !!! Main.UserApp is configured as an alias for Main.JuliaNoGeniePoc and you might encounter it in some tests
using Main.JuliaNoGeniePoc, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "JuliaNoGeniePoc tests" begin
  @includetests ARGS
end
